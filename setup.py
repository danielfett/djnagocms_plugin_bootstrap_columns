...
setup(
    ...
    zip_safe=False,
    keywords=['django', 'djangocms', 'django-cms', 'plugin', 'bootstrap', 'columns']
    #download_url='https://github.com/jtiki/djnagocms_plugin_bootstrap_columns/archive/master.zip'
)
