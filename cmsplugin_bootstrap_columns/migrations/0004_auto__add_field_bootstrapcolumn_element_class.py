...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BootstrapColumn.element_class'
        db.add_column(u'cmsplugin_bootstrap_columns_bootstrapcolumn', 'element_class',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BootstrapColumn.element_class'
        db.delete_column(u'cmsplugin_bootstrap_columns_bootstrapcolumn', 'element_class')
    ...
    models = {
        ...
        u'cmsplugin_bootstrap_columns.bootstrapcolumn': {
            ...
            'element_class': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
