...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_bootstrap_columns_bootstraprow', (
        ...
        db.send_create_signal(u'cmsplugin_bootstrap_columns', ['BootstrapRow'])

        # Adding model 'BootstrapColumn'
        db.create_table(u'cmsplugin_bootstrap_columns_bootstrapcolumn', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('mobile_device_width', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('small_device_width', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('medium_device_width', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('large_device_width', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('element_style', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('element_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('hide_on_mobile', self.gf('django.db.models.fields.BooleanField')()),
            ('hide_on_small', self.gf('django.db.models.fields.BooleanField')()),
            ('hide_on_medium', self.gf('django.db.models.fields.BooleanField')()),
            ('hide_on_large', self.gf('django.db.models.fields.BooleanField')()),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True)),
        ))
        db.send_create_signal(u'cmsplugin_bootstrap_columns', ['BootstrapColumn'])


    def backwards(self, orm):
        # Deleting model 'BootstrapRow'
        db.delete_table(u'cmsplugin_bootstrap_columns_bootstraprow')

        # Deleting model 'BootstrapColumn'
        db.delete_table(u'cmsplugin_bootstrap_columns_bootstrapcolumn')
